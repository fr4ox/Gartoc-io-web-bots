...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        ...
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "developer: Seda & Enes"}" placeholder="Nickname" maxlength="17" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
...
<a href="Optimized.html" class="ui right floated
...
<div class="field"><div class="ui labeled input" id="messagetext"><input type="text" value="${params.get('message-text') || "developer : Seda & Enes"}" placeholder="Message text" maxlength="1000" spellcheck="false" data-ms-editor="true"></div></div><div class="field">
      ...
      try {
        ...
        if (filterPeople) {
          ...
          if (regex.test(username)) {
            document.querySelector('#botname div input').value = "developer : Seda & Enes";
            username = "";
          }
        }
    ...
    socket.addEventListener('message', (event) => {
      ...
      switch (data[0]) {
        case 5: {
          ...
          if (params.get('private-mode') !== "true") { socket.send(`42[11,"${playerId}","developer : Seda & Enes"]`); }
        ...
        case 11: {
          ...
          if (!messageSent) {
            ...
            if (data[2] === "!link") {
              ...
              socket.send(`42[11,"${playerId}","https://.github.io/gartic.io-bot/v2/ (Site Closed)"]`);
            }
  ...
  if (socketList) {
    ...
    socketList.forEach(function (socket) {
      if (socket.readyState === WebSocket.OPEN) {
        if (params.get('private-mode') === "true") { socket.send(`42[11,"${socket.playerId}","developer : Seda & Enes"]`); }
        socket.close();
        socket.onerror = null;
        socket.onclose = null;
      }
